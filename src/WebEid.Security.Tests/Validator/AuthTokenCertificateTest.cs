namespace WebEid.Security.Tests.Validator
{
    ...
    public class AuthTokenCertificateTest : AbstractTestWithValidator
    {
        ...
        [Test]
        public void WhenCertificatePurposeIsMissingThenValidationFailsAsync()
        {
            var authToken = this.ReplaceTokenField(AuthToken, "X5C", MissingPurposeCert);
