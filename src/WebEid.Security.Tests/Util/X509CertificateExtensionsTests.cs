namespace WebEid.Security.Tests.Util
{
    ...
    public class X509CertificateExtensionsTests
    {
        ...
        public void SetUp()
        {
            this.certificate = CertificateLoader.LoadCertificateFromResource("Karl-Kristjan-Joeorg.cer");
        }
        ...
        [Test]
        public void ValidateBcValidCertificateExpiryDoesNotThrowException()
        {
            Assert.DoesNotThrow(() =>
                DotNetUtilities.FromX509Certificate(this.certificate)
        ...
        [Test]
        public void ValidateNotYetValidCertificateExpiryThrowsException()
        {
            Assert.Throws<CertificateNotYetValidException>(() =>
        ...
        [Test]
        public void ValidateExpiredCertificateExpiryThrowsException()
        {
            Assert.Throws<CertificateExpiredException>(() =>
                new X509Certificate2(this.certificate)
                    .ValidateCertificateExpiry(new DateTime(2030, 1, 1), "Test"));
        ...
        [Test]
        public void ValidateValidCertificateExpiryDoesNotThrowException()
        {
            Assert.DoesNotThrow(() =>
                new X509Certificate2(this.certificate)
                    .ValidateCertificateExpiry(new DateTime(2021, 08, 1), "Test"));
